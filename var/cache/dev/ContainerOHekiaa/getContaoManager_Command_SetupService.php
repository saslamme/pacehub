...
class getContaoManager_Command_SetupService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['contao_manager.command.setup'] = $instance = new \Contao\ManagerBundle\Command\ContaoSetupCommand(\dirname(__DIR__, 4), (\dirname(__DIR__, 4).'/web'), $container->getEnv('APP_SECRET'));
