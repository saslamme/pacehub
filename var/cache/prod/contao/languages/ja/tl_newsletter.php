...
$GLOBALS['TL_LANG']['tl_newsletter']['mailerTransport'][0] = 'メールトランスポート';
$GLOBALS['TL_LANG']['tl_newsletter']['mailerTransport'][1] = 'このチャネルのメールトランスポートの初期値を上書きできます。';
...
$GLOBALS['TL_LANG']['tl_newsletter']['skipped'] = '%s個のメールアドレスを飛ばしました。';
