...
// vendor/contao/core-bundle/src/Resources/contao/languages/ja/tl_style.xlf
...
$GLOBALS['TL_LANG']['tl_style']['size'][1] = 'width, height, min-width, min-height, max-width, max-heightを入力できます。';
...
$GLOBALS['TL_LANG']['tl_style']['positioning'][0] = '位置(top, right, bottom, left)';
$GLOBALS['TL_LANG']['tl_style']['positioning'][1] = 'position、float、clear、overflow、displayを入力できます。';
...
$GLOBALS['TL_LANG']['tl_style']['alignment'][1] = 'margin、padding、align、vertical-align、text-align、white-spaceを入力できます。';
$GLOBALS['TL_LANG']['tl_style']['margin'][0] = 'マージン(margin)';
$GLOBALS['TL_LANG']['tl_style']['margin'][1] = '上、右、下、左の余白(マージン)を入力できます。';
...
$GLOBALS['TL_LANG']['tl_style']['whitespace'][0] = '空白';
$GLOBALS['TL_LANG']['tl_style']['whitespace'][1] = '要素の内部のwhite-spaceをどのように扱うかを指定できます。';
$GLOBALS['TL_LANG']['tl_style']['background'][0] = '背景';
$GLOBALS['TL_LANG']['tl_style']['background'][1] = 'background-color、background-image、background-position、background-repeat、linear-gradient、box-shadowを入力できます。';
...
$GLOBALS['TL_LANG']['tl_style']['border'][1] = 'border-width, border-style, border-color, border-radius, border-collapse, border-spacingを入力できます。';
...
$GLOBALS['TL_LANG']['tl_style']['font'][1] = 'font-family、font-size、font-color、line-height、font-style、text-transform、text-indent、letter-spacing、word-spacingを入力できます。';
...
$GLOBALS['TL_LANG']['tl_style']['letterspacing'][1] = '文字の間隔を修正できます。(初期設定: 0px)';
$GLOBALS['TL_LANG']['tl_style']['wordspacing'][0] = '単語の間隔(word-spacing)';
$GLOBALS['TL_LANG']['tl_style']['wordspacing'][1] = '単語の間隔を修正できます。(初期設定: 0px)';
...
$GLOBALS['TL_LANG']['tl_style']['position_legend'] = '位置(top, right, bottom, left)';
...
$GLOBALS['TL_LANG']['tl_style']['editheader'] = 'このスタイルシートの設定を変更';
$GLOBALS['TL_LANG']['tl_style']['toggle'] = 'ID %sの要素を有効/無効';
