...
// vendor/contao/core-bundle/src/Resources/contao/languages/sv/tl_style.xlf
...
$GLOBALS['TL_LANG']['tl_style']['alignment'][1] = 'Margin, padding, align, vertical-align, text-align och white-space.';
...
$GLOBALS['TL_LANG']['tl_style']['whitespace'][1] = 'Här kan du specificera hur white-space inom ett element ska hanteras.';
$GLOBALS['TL_LANG']['tl_style']['background'][0] = 'Bakgrund';
$GLOBALS['TL_LANG']['tl_style']['background'][1] = 'Background-color, background-image, background-position, background-repeat, box-shadow och linear-gradient.';
...
$GLOBALS['TL_LANG']['tl_style']['font'][1] = 'Font-family, font-size, font-color, line-height, font-style, text-transform, text-indent, letter-spacing och word-spacing.';
...
$GLOBALS['TL_LANG']['tl_style']['own'][0] = 'Egendefinierad kod';
...
$GLOBALS['TL_LANG']['tl_style']['editheader'] = 'Redigera inställningarna för denna stilmall';
$GLOBALS['TL_LANG']['tl_style']['toggle'] = 'Aktivera / avaktivera element ID %s';
